...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/project-2.jpg", width: 1200, height: 630, alt: "Recent Interior Design Projects by I Sketch Interiors" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Recent Interior Design Projects — I Sketch Interiors",
    description: "125+ completed luxury interior design projects across Thane, Mumbai, Pune, and internationally.",
  ...
  return (
    <>
      <StructuredData data={getWebPageSchema({
        ...
        description: "Browse recent luxury interior design projects by I Sketch Interiors across Thane, Mumbai, Pune, and internationally.",
        url: "/projects",
        type: "CollectionPage",
      })} />
      <StructuredData

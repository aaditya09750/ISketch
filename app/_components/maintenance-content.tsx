...
export function MaintenanceContent() {
  ...
  const contactLinks = [
    { label: "studio@isketchinteriors.com", href: "mailto:studio@isketchinteriors.com" },
    { label: "+91 99673 12203", href: "tel:+919967312203" },
    { label: "Instagram", href: "https://www.instagram.com/isketchinteriors/" },
  ]
    ...
    <section className="relative h-screen flex flex-col items-center justify-between overflow-hidden py-8 sm:py-10 lg:py-12">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 sm:px-8 w-full max-w-md sm:max-w-lg lg:max-w-xl">
        ...
        <div className="relative">
          ...
          >
            <a
              href="mailto:studio@isketchinteriors.com"
      ...
      >
        <nav className="flex flex-wrap items-center justify-center gap-5 sm:gap-7 md:gap-9">
